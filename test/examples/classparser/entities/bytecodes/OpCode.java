...
public enum OpCode implements NumericEnum{
	nop(0x0,0),
	aconst_null(0x1,0),
	iconst_m1(0x2,0),
	iconst_0(0x3,0),
	...
	private OpCode(int opcode, int otherBytesLength) {
		this.opcode = opcode;
		this.otherBytesLength = otherBytesLength;
		String opcodeStr = Integer.toHexString(opcode);
		this.opcodeStr = (opcodeStr.length()==1 ? "0"+opcodeStr : opcodeStr.substring(opcodeStr.length()-2))+"("+opcode+")";
	}
	public int getOrdinal() {
		return opcode;
	}
	public int getOtherBytesLength() {
		if(otherBytesLength==-1) {
	...
	public String toString() {
		return opcodeStr+" "+name().toLowerCase();
	}
	@Override
