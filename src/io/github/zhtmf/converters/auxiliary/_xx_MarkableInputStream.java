 ...
 * @author dzh
 */
public final class _xx_MarkableInputStream extends InputStream implements AutoCloseable{
    ...
    public _xx_MarkableInputStream(InputStream is) {
        if(is==null) {
